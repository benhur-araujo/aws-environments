    ...
    Statement = [{
      ...
      Condition = {
        StringLike = {
          ...
          "token.actions.githubusercontent.com:sub" = "repo:benhur-sre/aws-environments:*",    # Examples of supported Subjects: https://docs.github.com/en/actions/deployment/security-hardening-your-deployments/about-security-hardening-with-openid-connect#example-subject-claims
          "token.actions.githubusercontent.com:sub" = "repo:benhur-sre/gh-reusable-workflows:*",
